...
func _enter_tree() -> void:
	...
	var inferred_declaration: int = int(ProjectSettings.get_setting("debug/gdscript/warnings/inferred_declaration", 0))
	var exclude_addons: bool = bool(ProjectSettings.get_setting("debug/gdscript/warnings/exclude_addons", true))
